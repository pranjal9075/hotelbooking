...
const FeaturedDestination = () => {
  ...
  return (
    <div className='flex flex-col items-center px-4 md:px-16 lg:px-24 bg-slate-50 py-20'>
        ...
        <div className='flex flex-wrap justify-center gap-6 items-center mt-20'>
            {
        ...
        <button onClick={()=>{navigate('/rooms'); scrollTo(0,0)}} className='my-16 px-4 py-2 text-sm font-medium border border-gray-300 rounded bg-white hover:bg-gray-50 transition-all cursor-pointer'>View All Distinations</button>
    </div>
  )
}
